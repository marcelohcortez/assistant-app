...
export default function Features() {
  return (
    <View style={{height: hp(60)}} className="space-y-4">
      ...
      <View className="bg-emerald-200 p-4 rounded-xl space-y-z">
      ...
      <View className="bg-purple-200 p-4 rounded-xl space-y-z">
        <View className="flex-row items-center space-x-1">
      ...
      <View className="bg-cyan-200 p-4 rounded-xl space-y-z">
        <View className="flex-row items-center space-x-1">
